...
void readPositiveVoltage() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 00, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 18, 18); delay (100); // Dummy Read added on 06 07 2021
...
void readNegativeVoltage() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 40, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 58, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(36, VNegative, 36);
  delay (100);
}

void readPFuse() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 80, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 98, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(72, PFuse, 36);
  delay (100);
}

void readOFuse() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 120, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 138, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(108, OFuse, 36);
  delay (100);
}

void readNFuse() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 160, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 178, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(144, NFuse, 36);
  delay (100);
}

void readCPositive() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 200, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 218, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(180, CPositive, 36);
  delay (100);
}

void readCNegative() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 240, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 258, 18); delay (100); // Dummy Read added on 06 07 2021
 ...
 ///   Serial.println(ModbusRTUClient.available());
  ...
  modbusTCPServer.writeInputRegisters(216, CNegative, 36);
  delay (100);
}

void readTemp() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 280, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 298, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(252, Temperature, 36);
  delay (100);
}

void readSwitch() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 320, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 238, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(288, Switch, 36);
  delay (100);
}

void readLife() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 360, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 378, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(324, Life, 36);
  delay (100);
}

void readDOD() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 400, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 418, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  modbusTCPServer.writeInputRegisters(360, DOD, 36);
  delay (100);
}

void readCycles() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 480, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 498, 18); delay (100); // Dummy Read added on 06 07 2021
...
//erial.println("success readCycles 25");
  ...
  modbusTCPServer.writeInputRegisters(396, Cycles, 36);
  delay (100);
}

void readAH() {
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 520, 18); delay (100); // Dummy Read added on 06 07 2021
  ...
  ModbusRTUClient.requestFrom(1, INPUT_REGISTERS, 538, 18); delay (100); // Dummy Read added on 06 07 2021
 ...
 //   Serial.println(ModbusRTUClient.available());
  ...
  modbusTCPServer.writeInputRegisters(432, AH, 36);
  delay (100);
}
